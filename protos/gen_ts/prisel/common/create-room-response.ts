...
export class CreateRoomResponse {
  ...
  bb_pos = 0;
__init(i:number, bb:flatbuffers.ByteBuffer):CreateRoomResponse {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsCreateRoomResponse(bb:flatbuffers.ByteBuffer, obj?:CreateRoomResponse):CreateRoomResponse {
  return (obj || new CreateRoomResponse()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsCreateRoomResponse(bb:flatbuffers.ByteBuffer, obj?:CreateRoomResponse):CreateRoomResponse {
...
static startCreateRoomResponse(builder:flatbuffers.Builder) {
...
static endCreateRoomResponse(builder:flatbuffers.Builder):flatbuffers.Offset {
