...
const baseGetRoomStateResponse: object = {
  hostId: "",
  token: "",
};
...
export const GetRoomStateResponse = {
  ...
  decode(input: Uint8Array | Reader, length?: number): GetRoomStateResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseGetRoomStateResponse } as GetRoomStateResponse;
    message.players = [];
  ...
  fromJSON(object: any): GetRoomStateResponse {
    const message = { ...baseGetRoomStateResponse } as GetRoomStateResponse;
    message.players = [];
  ...
  fromPartial(object: DeepPartial<GetRoomStateResponse>): GetRoomStateResponse {
    const message = { ...baseGetRoomStateResponse } as GetRoomStateResponse;
    message.players = [];
    if (object.players !== undefined && object.players !== null) {
      for (const e of object.players) {
  ...
  toJSON(message: GetRoomStateResponse): unknown {
    const obj: any = {};
    if (message.players) {
