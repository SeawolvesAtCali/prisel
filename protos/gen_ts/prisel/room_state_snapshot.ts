...
// @generated from protobuf file "prisel/room_state_snapshot.proto" (package "prisel", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message prisel.RoomStateSnapshot
 */
...
class RoomStateSnapshot$Type extends MessageType<RoomStateSnapshot> {
    constructor() {
        super("prisel.RoomStateSnapshot", [
    ...
    create(value?: PartialMessage<RoomStateSnapshot>): RoomStateSnapshot {
        const message = { players: [], token: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<RoomStateSnapshot>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RoomStateSnapshot): RoomStateSnapshot {
    ...
    internalBinaryWrite(message: RoomStateSnapshot, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message prisel.RoomStateSnapshot
 */
export const RoomStateSnapshot = new RoomStateSnapshot$Type();
